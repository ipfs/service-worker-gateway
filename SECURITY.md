...
a bug in this software. Report it to whoever runs the gateway you used. For
`ipfs.io` and `dweb.link`, follow the [abuse policy](https://docs.ipfs.tech/concepts/public-utilities/#abuse-policy).

## Everything else

For normal bugs, [open an issue](https://github.com/ipfs/service-worker-gateway/issues/new/choose).
