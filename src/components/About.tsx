...
export default function About (): ReactElement {
  return (
        <aside className='mw7 lb-snow center w-100 lh-copy pa2 e2e-section-about'>
          ...
          <p><strong>Found a bug?</strong> We welcome you to report it by <a href="https://github.com/ipfs/service-worker-gateway/issues/new" target="_blank">opening an issue</a> with details like an address and a screenshot. If you need to manually <a href="https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerRegistration/unregister" target="_blank">unregister</a> the service worker, you can do so by appending <code>?ipfs-sw-unregister=true</code> to the URL.</p>
        </aside>
  )
}
