...
export default function About (): ReactElement {
  return (
    <aside className='mw7 lb-snow center w-100 lh-copy pa2 e2e-section-about'>
      ...
      <p><strong>Want to report abuse?</strong> The instance deployed at <code>inbrowser.link</code> blocks content identified by <a href='https://badbits.dwebops.pub/' target='_blank' rel='noreferrer'>Bad Bits</a>. To report abuse, please visit <a href='https://badbits.dwebops.pub/#reporting' target='_blank' rel='noreferrer'>badbits.dwebops.pub/#reporting</a>.</p>
