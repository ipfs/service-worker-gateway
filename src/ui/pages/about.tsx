...
export default function About (): ReactElement {
  return (
    <div className='e2e-section-about pa4-l bg-snow mw7 mv4-l center pa4 br2'>
      ...
      <p className='charcoal db pt1 lh-copy mb2'><span className='f5 ma0 pt3 teal fw4 db'>Want to report abuse?</span> This gateway uses the <Link href='https://badbits.dwebops.pub/'>Bad Bits</Link> blocklist. To report harmful content, see <Link href='https://about.ipfs.io/#reporting-abuse'>Reporting Abuse</Link>.</p>
