...
export default function About (): ReactElement {
  return (
    <div className='e2e-section-about pa4-l bg-snow mw7 mv4-l center pa4 br2'>
      ...
      <p className='charcoal db pt1 lh-copy mb2'><span className='f5 ma0 pt3 teal fw4 db'>Why?</span> It improves decentralization, offers enhanced security (CID verification happens on end user's machine) and reliability (ability to do retrieval from multiple sources without reliance on a single HTTP server).</p>
