...
test.describe('_redirects', () => {
  test('should perform redirect', async ({ page, baseURL, protocol, host }) => {
  ...
  test('should perform redirect with wildcard', async ({ page, baseURL, protocol, host }) => {
    ...
    expect(await response.text()).toContain('my 451')
  })
})
